...
const Notification = () => {
    ...
    const modifiedNotifications = notifications.map((n) => {const sender = allUsers.find(user => user?._id === n.senderId)
        return {
            ...n,
    ...
    return (
        <div className='notifications'>
            ...
            </div>
            {
                ...
                {modifiedNotifications.length === 0 ? <span class='notification'>No notification yet...</span> : null}
